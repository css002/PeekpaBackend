...
SECRET_KEY = "django-insecure-e8!jl_kus5dn54x84!%^a&=sz0x%z*cegebq#^6uvi&^%7enlu"
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='peekpa_db'),
...
SIMPLE_JWT = {
    ...
    'AUTH_TOKEN_CLASSES': ('apps.api.authentications.PeekpaAccessToken',),
